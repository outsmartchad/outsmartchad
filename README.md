...
- [outsmart-agent](https://github.com/outsmartchad/outsmart-agent) — Autonomous onchain infrastructure for AI agents — lp sniping, lp farming, launching percolator perps, trenching, devving coins, polymarket bets, and an MCP server so agents can earn to stay alive
