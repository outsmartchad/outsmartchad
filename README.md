...
- [outsmart-agent](https://github.com/outsmartchad/outsmart-agent) — Autonomous trading infrastructure for AI agents on Solana — lp sniping, lp farming, percolator perps, trenching, devving coins, polymarket bets, and an MCP server so agents can earn to stay alive
