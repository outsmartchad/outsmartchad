...
My work sits at the intersection of **DeFi**, **MEV**, and **AI agents**. I've built tools used by hundreds of traders and contributed to core Solana ecosystem SDKs.
...
- [outsmart-agent](https://github.com/outsmartchad/outsmart-agent) — Autonomous trading infrastructure for AI agents on Solana — LP sniping, farming, trenching, devving coins, Polymarket bets, and an MCP server so agents can earn to stay alive
...
<sub>Hong Kong · [X @svincents2](https://x.com/svincents2) · [LinkedIn](https://www.linkedin.com/in/vincent-so-22640b279/)</sub>
